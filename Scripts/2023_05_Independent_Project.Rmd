...
.pull-left[
```{r, sci-lineplot, eval=FALSE, warning=FALSE, message=FALSE}
...
.pull-right[
```{r sci-lineplot-out, ref.label="sci-lineplot", echo=FALSE, warning=FALSE, message=FALSE}
```
]
...
.pull-left[
```{r, sci-boxplot, eval=FALSE, warning=FALSE, message=FALSE}
sci_temp_data %>%
...
.pull-right[
```{r sci-boxplot-out, ref.label="sci-boxplot", echo=FALSE, warning=FALSE, message=FALSE}
```
]
---
...
.pull-right[
```{r function1-out, ref.label="function1", echo=FALSE, warning=FALSE, message=FALSE}
...
.pull-left[
```{r function2, eval=FALSE, warning=FALSE, message=FALSE}
...
.pull-right[
```{r function2-out, ref.label="function2", echo=FALSE, warning=FALSE, message=FALSE}
```
]
